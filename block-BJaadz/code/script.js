...
let seventeen = document.body.children[0].children[1].lastElementChild.style.display = "none"

// Change the border of all the hr element from solid to dashed type

allHrsArray.forEach((ele) => {
  ele.style.border = "1px dashed tomato";
})
...
box3.append("Prepend inserts as first child")

// Change the border of box 4 to '1px solid black'

let box4 = document.querySelector(".four");
box4.style.border = "1px solid blue";
